        ...
        >
          <SwiperSlide>
            <div className="slide-content">
              <h2>Slide 1</h2>
              <button className="nav-btn" onClick={() => navigate(ROUTERS.SUB1)}>Go to SubPage 1</button>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="slide-content">
              <h2>Slide 2</h2>
              <button className="nav-btn" onClick={() => navigate(ROUTERS.SUB2)}>Go to SubPage 2</button>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="slide-content">
              <h2>Slide 3</h2>
              <button className="nav-btn" onClick={() => navigate(ROUTERS.SUB3)}>Go to SubPage 3</button>
            </div>
          </SwiperSlide>
        </Swiper>
